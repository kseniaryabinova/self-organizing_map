...
Самоорганизующаяся карта Кохонена была реализована с помощью двух технологий параллельного программирования: OpenMP и CUDA.

В результате карта после обучения выглядит вот так:
